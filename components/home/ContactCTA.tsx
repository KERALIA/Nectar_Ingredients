    ...
    <section className="relative py-32 bg-ni-surface overflow-hidden border-t border-ni-border/15">
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-10">
          ...
          <Button variant="ghost" size="lg" href="mailto:nectaringredients@gmail.com" className="rounded-full px-7 py-4 text-xs font-bold uppercase tracking-widest glass-panel border border-ni-border2/30 text-ni-primary hover:border-ni-rust hover:text-ni-rust transition-all duration-300 hover:-translate-y-0.5">
            Email Directly
          </Button>
        </div>
