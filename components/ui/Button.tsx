...
export default function Button({
  ...
  const classes = `inline-flex items-center justify-center rounded-none font-body font-medium transition-all duration-200 cursor-pointer ${sizeClasses[size]} ${variantClasses[variant]} ${className}`
